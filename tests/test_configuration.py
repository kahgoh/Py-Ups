...
def test_configuration_no_encryption(tmp_path) -> None:
    ...
    """
    created_configuration = __set_up_no_encryption(s3_bucket="abc", repository_path=tmp_path)

    assert created_configuration == Configuration(s3_bucket = "abc", encryption_password = None)
...
def test_read_configuration_no_encryption(tmp_path) -> None:
    ...
    it has been set up.
    """
    created_configuration = __set_up_no_encryption(s3_bucket="def", repository_path=tmp_path)
    read_configuration = configuration.get_configuration(repository_path=tmp_path)

    assert created_configuration == read_configuration

def __set_up_with_encryption(s3_bucket: str, password: str, repository_path) -> None:
    """
...
def __read_configuration_with_encryption(password: str, repository_path) -> None:
    """
...
def test_configuration_with_encryption(tmp_path) -> None:
    ...
    """
    created_configuration = __set_up_with_encryption(s3_bucket="bucket", password="abc", repository_path=tmp_path)
...
def test_read_configuration_with_encryption(tmp_path) -> None:
    ...
    """
    created_configuration = __set_up_with_encryption(s3_bucket="bucket2", password="test", repository_path=tmp_path)
    read_configuration = __read_configuration_with_encryption(repository_path=tmp_path, password="test")
